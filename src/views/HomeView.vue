    ...
    data() {
        return {
            heroSection: {
                title: "WELCOME!",
                blogPost:
                    "I could have used Wordpress, but I did oversabi and built this with Vue, Tailwind and a Laravel API. Register so I see if mailgun API is working 😁 ",
                isHero: true,
    ...
    <div class="font-body">
        ...
        <div>
            <div class="flex flex-col md:flex-row md:justify-around md:align-middle p-5">
                ...
                <router-link class="text-white bg-gray-900 rounded-full w-24 p-2 my-3 hover:bg-gray-300 hover:text-gray-900 text-center" to="#">Register!</router-link>
            </div>
        </div>
    </div>
</template>