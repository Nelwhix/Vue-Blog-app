...
<template>
    <div class="grid md:grid-cols-2 bg-zinc-800 text-white">
        <div class="grid col p-7 md:place-content-center md:odd:order-first">
            ...
            <p class="my-3" v-else v-html="post.blogHTML"></p>
        ...
        <div class="col order-first">
            ...
            <img v-else :src="post.coverPhotoURL" class="w-full">
        </div>
    </div>
