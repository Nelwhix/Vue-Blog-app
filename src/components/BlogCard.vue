    ...
    <div>
        <div class="transition-transform ease-in-out card hover:-rotate-1 dark:bg-gray-800 dark:text-white">
            ...
            <div class="absolute flex gap-3 top-2 right-1 dark:text-black" :class="{ 'hidden': editMode }">
                <button title="Edit Blog Post" @click="$emit('edit-post', post.id)" class="bg-white rounded-full p-1 hover:bg-gray-700 hover:text-white">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                        <path d="M17.414 2.586a2 2 0 00-2.828 0L7 10.172V13h2.828l7.586-7.586a2 2 0 000-2.828z" />
                        <path fill-rule="evenodd" d="M2 6a2 2 0 012-2h4a1 1 0 010 2H4v10h10v-4a1 1 0 112 0v4a2 2 0 01-2 2H4a2 2 0 01-2-2V6z" clip-rule="evenodd" />
                    </svg>
                </button>
                <button title="Delete Blog Post" @click="$emit('delete-post', post.id)" class="bg-white rounded-full p-1 hover:bg-gray-700 hover:text-white">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
